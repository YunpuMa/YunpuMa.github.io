...
<div class="news-media" id="news-media-gsts-2026">
  <div class="news-media-inner news-media-gallery">
    <img src="{{ '/assets/img/news/gsts-2026-talk-1.png' | relative_url }}" alt="Invited talk at the Global Software Technology Summit 2026 in Berlin">
    <img src="{{ '/assets/img/news/gsts-2026-talk-2.png' | relative_url }}" alt="Conference presentation at the Global Software Technology Summit 2026 in Berlin">
  </div>
</div>
